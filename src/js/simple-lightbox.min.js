            ...
            var t = (function () {
              function i(t, e) {
                ...
                !(function (t, e) {
                  ...
                  s(this, 'isAppleDevice', /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform)),
                  ...
                  'string' == typeof t
                    ...
                    : (this.elements = void 0 !== t.length && 0 < t.length ? Array.from(t) : [t]),
                ...
                (e = [
                    ...
                    value: function (t) {
                      ...
                      return (
                        'hide' === t
                          ? ((t = window.innerWidth) ||
                              (t =
                                (e = document.documentElement.getBoundingClientRect()).right -
                                Math.abs(e.left)),
                            (document.body.clientWidth < t || this.isAppleDevice) &&
                              ((e = document.createElement('div')),
                              (t = parseInt(document.body.style.paddingRight || 0, 10)),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      if (
                        this.isAnimating ||
                        ((t < 0 || t >= this.relatedElements.length) && !1 === this.options.loop)
                      )
                        return !1;
                      ...
                      t.setAttribute('src', this.currentImage.getAttribute('src')),
                        ...
                        t.addEventListener('load', function (t) {
                          void 0 !== s &&
                            ...
                            a.relatedElements[a.currentImageIndex].dispatchEvent(
                              new Event(
                                (1 === s ? 'nextDone' : 'prevDone') + '.' + a.eventNamespace,
                              ),
                            )),
                            a.options.history && a.updateURL(),
                            -1 === a.loadedImages.indexOf(a.currentImage.getAttribute('src')) &&
                              a.loadedImages.push(a.currentImage.getAttribute('src'));
                          var e,
                            o,
                            n = t.target.width,
                            i = t.target.height;
                          (a.options.scaleImageToRatio || r < n || l < i) &&
                            ((n /= t = r / l < n / i ? n / r : i / l), (i /= t)),
                            (a.domNodes.image.style.top = (window.innerHeight - i) / 2 + 'px'),
                            (a.domNodes.image.style.left =
                              (window.innerWidth - n - a.globalScrollbarWidth) / 2 + 'px'),
                            ...
                            'string' == typeof a.options.captionSelector
                              ? (e =
                                  'self' === a.options.captionSelector
                                    ...
                                    : a.relatedElements[a.currentImageIndex].querySelector(
                                        a.options.captionSelector,
                                      ))
                              : 'function' == typeof a.options.captionSelector &&
                            ...
                            a.options.loop
                              ? 1 === a.relatedElements.length
                                ? a.hide(
                                    a.domNodes.navigation.querySelectorAll('.sl-prev, .sl-next'),
                                  )
                                : a.show(
                                    a.domNodes.navigation.querySelectorAll('.sl-prev, .sl-next'),
                                  )
                              : (0 === a.currentImageIndex &&
                                  a.hide(a.domNodes.navigation.querySelector('.sl-prev')),
                                a.currentImageIndex >= a.relatedElements.length - 1 &&
                                  a.hide(a.domNodes.navigation.querySelector('.sl-next')),
                                0 < a.currentImageIndex &&
                                  a.show(a.domNodes.navigation.querySelector('.sl-prev')),
                                a.currentImageIndex < a.relatedElements.length - 1 &&
                                  a.show(a.domNodes.navigation.querySelector('.sl-next'))),
                            1 === s || -1 === s
                            ...
                            a.options.additionalHtml &&
                              ...
                              ((a.domNodes.additionalHtml = document.createElement('div')),
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              ...
                              0 == n.controlCoordinates.containerHeight &&
                                ((n.controlCoordinates.containerHeight = n.getDimensions(
                                  n.domNodes.image,
                                ).height),
                                (n.controlCoordinates.containerWidth = n.getDimensions(
                                  n.domNodes.image,
                                ).width),
                                ...
                                (n.controlCoordinates.initialOffsetX = parseFloat(
                                  n.currentImage.dataset.translateX,
                                )),
                                (n.controlCoordinates.initialOffsetY = parseFloat(
                                    ...
                                    : n.minMax(
                                        n.controlCoordinates.initialOffsetX -
                                          ((n.controlCoordinates.pinchOffsetX -
                                            n.controlCoordinates.containerOffsetX -
                                            n.controlCoordinates.containerWidth / 2 -
                                            n.controlCoordinates.initialOffsetX) /
                                            (n.controlCoordinates.targetScale -
                                              n.controlCoordinates.scaleDifference)) *
                                            n.controlCoordinates.scaleDifference,
                                    ...
                                    : n.minMax(
                                        n.controlCoordinates.initialOffsetY -
                                          ((n.controlCoordinates.pinchOffsetY -
                                            n.controlCoordinates.containerOffsetY -
                                            n.controlCoordinates.containerHeight / 2 -
                                            n.controlCoordinates.initialOffsetY) /
                                            (n.controlCoordinates.targetScale -
                                              n.controlCoordinates.scaleDifference)) *
                                            n.controlCoordinates.scaleDifference,
                                ...
                                1 < n.controlCoordinates.targetScale
                                  ? ((n.controlCoordinates.zoomed = !0),
                                    n.domNodes.caption.style.opacity ||
                                      'none' === n.domNodes.caption.style.display ||
                                      n.fadeOut(n.domNodes.caption, n.options.fadeSpeed))
                              ...
                              if (
                                ...
                                if (n.controlCoordinates.doubleTapped)
                                  return (
                                    ...
                                    setTimeout(function () {
                                      n.currentImage &&
                                        n.currentImage.classList.remove('sl-transition');
                                    }, 200),
                                    !1
                                  );
                                ...
                                2 === n.controlCoordinates.touchCount &&
                                  ...
                                  (n.controlCoordinates.pinchOffsetY =
                                    (n.controlCoordinates.initialPointerOffsetY +
                                      n.controlCoordinates.initialPointerOffsetY2) /
                                    2),
                                  (n.controlCoordinates.initialPinchDistance = Math.sqrt(
                                    (n.controlCoordinates.initialPointerOffsetX -
                                      n.controlCoordinates.initialPointerOffsetX2) *
                                      (n.controlCoordinates.initialPointerOffsetX -
                                        n.controlCoordinates.initialPointerOffsetX2) +
                          ...
                          function (t) {
                            ...
                            if ('touchmove' === t.type) {
                              ...
                              (n.controlCoordinates.pointerOffsetX = t.touches[0].clientX),
                                ...
                                1 < n.controlCoordinates.touchCount
                                  ? ((n.controlCoordinates.pointerOffsetX2 = t.touches[1].clientX),
                                    (n.controlCoordinates.pointerOffsetY2 = t.touches[1].clientY),
                                    (n.controlCoordinates.targetPinchDistance = Math.sqrt(
                                    ...
                                    null === n.controlCoordinates.initialPinchDistance &&
                                      (n.controlCoordinates.initialPinchDistance =
                                        n.controlCoordinates.targetPinchDistance),
                                    1 <=
                                      Math.abs(
                                      ...
                                      ((n.controlCoordinates.targetScale = n.minMax(
                                        (n.controlCoordinates.targetPinchDistance /
                                          n.controlCoordinates.initialPinchDistance) *
                                          n.controlCoordinates.initialScale,
                                        1,
                            ...
                            n.controlCoordinates.zoomed ||
                              ((n.controlCoordinates.swipeEnd = t.pageX || t.touches[0].pageX),
                              (n.controlCoordinates.swipeYEnd = t.pageY || t.touches[0].pageY),
                              (n.controlCoordinates.swipeDiff =
                                n.controlCoordinates.swipeStart - n.controlCoordinates.swipeEnd),
                              (n.controlCoordinates.swipeYDiff =
                                n.controlCoordinates.swipeYStart - n.controlCoordinates.swipeYEnd),
                              ...
                              n.controlCoordinates.mousedown &&
                                ...
                                n.options.loop ||
                                  (0 === n.currentImageIndex &&
                                    n.controlCoordinates.swipeDiff < 0 &&
                                    (t = !1),
                                  n.currentImageIndex >= n.relatedElements.length - 1 &&
                                    0 < n.controlCoordinates.swipeDiff &&
                                    (t = !1)),
                                Math.abs(n.controlCoordinates.swipeDiff) >
                                  n.options.swipeTolerance && t
                                  ? n.loadImage(0 < n.controlCoordinates.swipeDiff ? 1 : -1)
                                  : n.options.animationSlide &&
                                    n.slide(n.options.animationSpeed / 1e3, '0px'),
                                n.options.swipeClose &&
                                  50 < Math.abs(n.controlCoordinates.swipeYDiff) &&
                                  Math.abs(n.controlCoordinates.swipeDiff) <
                            ...
                            return (
                              ...
                              n.controlCoordinates.zoomed
                                ? ((n.controlCoordinates.initialScale = 1),
                                  ...
                                  'none' === n.domNodes.caption.style.display &&
                                    n.fadeIn(n.domNodes.caption, n.options.fadeSpeed))
                                : ((n.controlCoordinates.initialScale = n.options.doubleTapZoom),
                                  n.setZoomData(n.controlCoordinates.initialScale, 0, 0),
                                  n.zoomPanElement('0px', '0px', n.controlCoordinates.initialScale),
                                  n.domNodes.caption.style.opacity ||
                                    'none' === n.domNodes.caption.style.display ||
                              ...
                              setTimeout(function () {
                                n.currentImage &&
                                  (n.currentImage.classList.remove('sl-transition'),
                                  (n.currentImage.style[n.transitionPrefix + 'transform-origin'] =
                                    null));
                              }, 200),
                              !(n.controlCoordinates.capture = !0)
                            );
                        ...
                        for (s.s(); !(i = s.n()).done; ) {
                          ...
                          try {
                            for (l.s(); !(r = l.n()).done; ) {
                              var d = r.value,
                                c = n || !1;
                              0 <= ['touchstart', 'touchmove'].indexOf(d.split('.')[0]) &&
                                this.isPassiveEventsSupported &&
                                ('object' === h(c) ? (c.passive = !0) : (c = { passive: !0 })),
                                (a.namespaces[d] = o),
                        ...
                        for (n.s(); !(o = n.n()).done; ) {
                          ...
                          try {
                            for (a.s(); !(i = a.n()).done; ) {
                              ...
                              s.namespaces &&
                                s.namespaces[r] &&
                                (s.removeEventListener(r.split('.')[0], s.namespaces[r]),
                  ...
                  },
                  {
                    ...
                    value: function (r, t, l) {
                      var e,
                        ...
                        o = m((r = this.wrap(r)));
                      try {
                        for (o.s(); !(e = o.n()).done; ) e.value.style.opacity = 1;
                      } catch (t) {
                        o.e(t);
                      } finally {
                        o.f();
                  ...
                  },
                  {
                    ...
                    value: function (a, t, r, e) {
                      ...
                      try {
                        for (n.s(); !(o = n.n()).done; ) {
                          var i = o.value;
                          (i.style.opacity = 0), (i.style.display = e || 'block');
                        }
                      } catch (t) {
                        n.e(t);
                      } finally {
                      ...
                      (function t() {
                        ...
                        if ((e += c) > d) {
                          var o,
                            n = m(a);
                          try {
                            for (n.s(); !(o = n.n()).done; ) o.value.style.opacity = '';
                          } catch (t) {
                            n.e(t);
                          } finally {
                            n.f();
                          ...
                          var i,
                            s = m(a);
                          try {
                            for (s.s(); !(i = s.n()).done; ) i.value.style.opacity = e;
                          } catch (t) {
                            s.e(t);
                          } finally {
                            s.f();
                      ...
                      try {
                        for (n.s(); !(o = n.n()).done; ) {
                          ...
                          try {
                            for (a.s(); !(s = a.n()).done; ) {
                              var r = s.value;
                              (i.fullyNamespacedEvents[r] = e), i.addEventListener(r, e);
                            }
                          } catch (t) {
                            a.e(t);
                          } finally {
